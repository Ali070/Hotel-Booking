    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                stmt.execute("INSERT INTO `hotel`.`reservation` (`Username`, `hotelname`, `checkin`, `checkout`, `price`, `roomname`, `nights`,totalprice,firstname,lastname,email,cardnumber,expireddate,phonenumber,confirmed,payment,checkinclient,checkoutclient) VALUES "
                        + "('"+username+"', '"+hotelname+"', '"+checkIN+"', '"+checkOut+"', '"+price+"', '"+roomsNames+"','"+nights+"','"+total+"','"+firstName+"','"+lastName+"','"+email+"','"+cardNum+"','"+expiireddate+"','"+phone+"','0','1','0','0');");
                String message = "*Reservation made successfully, wait for confirmation*";
