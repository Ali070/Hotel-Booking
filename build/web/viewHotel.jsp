...
.rating > input:checked ~ label:hover ~ label { color: #FFED85;  } </style>
    ...
    <script type="text/javascript">
        ...
        <%
                File directory=new File("E:\\Ali\\4th Year\\1st Term\\Internet applications\\htotelProject\\web\\images\\"+hotelName);
        ...
        <form method="post" action="MakeReservation.jsp" id="reserveForm" class="mkform">
            <table style="width: 100%; border: 1px solid black" >
                ...
                <%
                    ...
                    checkin = RS4.getString("checkin");
                    checkout = RS4.getString("checkout");
