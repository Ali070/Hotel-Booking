    ...
    <body class="loginBody">
        ...
        <div class="table1" style="display: inline-block;">
                ...
                <tr class="active-row">
                    ...
                    <td>
                        ...
                        <form action="cancelReservation" method="POST">
                            <input style="background:#009879;padding: 5px" class="btnLo" type="submit" value="Cancel" id="cancBtn" disabled>
                            <input type="hidden" name="username" value="<%=RS.getString("Username")%>">
                            <input type="hidden" name="ID" value="<%=id%>">
                            <input type="hidden" name="email" value="<%=RS.getString("email")%>">
                        </form>
                        <script>
                            var chk1 = "<%out.print(RS.getString("confirmed"));%>";
                            if(chk1=="1"){
            ...
            <%
                    ...
                    response.sendRedirect("viewReservations.jsp?message=*This id is invalid*");
                }
            %>
            <p style="color: crimson;" id="message"></p>
        </div>
        <script>
